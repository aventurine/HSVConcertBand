...
/***/ function(module, exports, __webpack_require__) {
	...
	var Detail = React.createClass({displayName: "Detail",
	  getInitialState:function () {
	    ...
	    return {
	      detail: [] //this.fetchDetails(this.props.rowData.ID)
	    }
	  },
	  fetchDetails:function(id){
	    var url = '/compositions/'+id;
	    //console.log(url);
	    ...
	    $.ajax({
	      ...
	      success: function(detail){
	        ...
	        this.setState({
	          ...
	          copyright: detail.COPYRIGHT_YEAR,
	          style: detail.STYLE,
	          last_perf: detail.DATE_LAST_PERFORMED,
	          last_pass: detail.DATE_LAST_PASSED_OUT,
	          comments: detail.COMMENTS,
	          condscore: detail.CONDENSED_SCORE
	        })
	        //console.log(detail);
	      }.bind(this)
	    })
	  ...
	  /*<a href={this.props.rowData.ID}>{this.props.rowData.ID}</a>*/
	  /*<div className="btn btn-large btn-primary detail-btn" data-id={this.props.rowData.ID}>DETAIL</div>*/
	  /*<button type="button" className="btn btn-large btn-primary" onClick={this.handleClick(this.props.rowData)}>DETAIL</button>*/
	  render:function(){
	    //var list = (typeof(this.state.detail) === 'array') ? 'true' : 'false'
	    //var comments = this.state.detail.COMMENTS
	    var list = (this.state.parts !== undefined) ? this.state.parts.map(function(item,key){ return React.createElement("li", {key: key}, " ", item.count, " | ", item.name, " ") }) : null
	    return (
	      React.createElement("div", {className: ""}, 

	        React.createElement("button", {className: "btn btn-large btn-primary", onClick: this.showSimpleDialog}, "DETAIL"), 

	        React.createElement(SkyLight, {className: "container", ref: "simpleDialog", title: this.props.rowData.TITLE}, 
	          React.createElement("div", {className: "container"}, 
	            React.createElement("div", {className: "row"}, 
	              React.createElement("div", {className: "col-md-4"}, React.createElement("div", {className: "row"}, "composer"), this.state.composer), 
	              React.createElement("div", {className: "col-md-4"}, React.createElement("div", {className: "row"}, "publisher"), this.state.publisher), 
	              React.createElement("div", {className: "col-md-4"}, React.createElement("div", {className: "row"}, "arranger"), this.state.arranger)
	            ), 

	            React.createElement("div", {className: "row"}, 
	              React.createElement("div", {className: "col-md-4"}, React.createElement("div", {className: "row"}, "copyright"), this.state.copyright), 
	              React.createElement("div", {className: "col-md-4"}, React.createElement("div", {className: "row"}, "last passed"), this.state.last_pass), 
	              React.createElement("div", {className: "col-md-4"}, React.createElement("div", {className: "row"}, "last performed"), this.state.last_perf)
	            ), 

	            React.createElement("div", {className: "row"}, 
	              React.createElement("div", {className: "col-md-12"}, React.createElement("div", {className: "row"}, "comments"), this.state.comments)
	            ), 

	            React.createElement("div", {className: "row"}, 
	              React.createElement("div", {className: "col-md-12"}, 
	              React.createElement("h6", null, "Instruments"), 
	...
	var App = React.createClass({displayName: "App",
	  getInitialState:function () {
	    return {
	      data: this.fetchAllCompositions()
	    }
	  },
	  ...
	  render:function () {
	    ...
	    return (
	      React.createElement("div", {className: "container"}, 
	       React.createElement("h1", null, "Huntsville Concert Band"), 

	        React.createElement("div", {className: "panel panel-default", style: styles.searchHeader}, 
	          React.createElement(Griddle, {
	           gridClassName: "composition-grid", 
	           results: this.state.data, 
	           showFilter: true, 
	           filterPlaceholderText: "Type here to filter results", 
